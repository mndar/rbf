...
class RbfDialogTest(unittest.TestCase):
    ...
    def test_readXml(self):
        ...
        self.assertEqual(self.creator.readXml(), rbfdialog.BoardTemplateCreator.ERROR_PARSING_XML)
    ...
    def test_readTags(self):
        ...
        self.assertEqual(self.creator.readXml(), 0)
        self.assertEqual(self.creator.readTags(), rbfdialog.BoardTemplateCreator.ERROR_PARSING_XML_TAGS)
    ...
    def test_readImageData(self):
        ...
        self.assertEqual(self.creator.readXml(), 0)
        self.assertEqual(self.creator.readImageData(), rbfdialog.BoardTemplateCreator.INVALID_IMAGE_SIZE)
    ...
    def test_readKernelData(self):
        ...
        self.assertEqual(self.creator.readXml(), 0)
        self.assertEqual(self.creator.readKernelData(),rbfdialog.BoardTemplateCreator.NO_KERNEL)
        
        #kernel type missing
        self.creator.setTemplate("test_templates/no_kernel_type.xml")
        self.assertEqual(self.creator.readXml(), 0)
        self.assertEqual(self.creator.readKernelData(),rbfdialog.BoardTemplateCreator.NO_KERNEL_TYPE)
        
        #custom kernel info missing/incorrect
        self.creator.setTemplate("test_templates/bad_custom_kernel.xml")
        self.assertEqual(self.creator.readXml(), 0)
        self.assertEqual(self.creator.readKernelData(),rbfdialog.BoardTemplateCreator.ERROR_READING_CUSTOM_KERNEL_INFO)
    ...
    def test_readPartitions(self):
        ...
        self.assertEqual(self.creator.readXml(), 0)
        self.assertEqual(self.creator.readPartitions(), rbfdialog.BoardTemplateCreator.NO_PARTITIONS)
    ...
    def test_readRepoData(self):
        ...
        self.assertEqual(self.creator.readXml(), 0)
        self.assertEqual(self.creator.readRepoData(), rbfdialog.BoardTemplateCreator.INCORRECT_REPOSITORY)
    ...
    def test_readPackages(self):
        ...
        self.assertEqual(self.creator.readXml(), 0)
        self.assertEqual(self.creator.readPackages(), rbfdialog.BoardTemplateCreator.NO_PACKAGES)
    ...
    def test_readNetworkData(self):
        ...
        self.assertEqual(self.creator.readXml(), 0)
        self.assertEqual(self.creator.readNetworkData(), rbfdialog.BoardTemplateCreator.NO_NETWORK)
        
        #missing data in network config
        self.creator.setTemplate("test_templates/two_network_one_incorrect.xml")
        self.assertEqual(self.creator.readXml(), 0)
        self.assertEqual(self.creator.readNetworkData(), rbfdialog.BoardTemplateCreator.BAD_NETWORK_DATA)
    ...
    def test_validatePartitionData(self):
        ...
        self.assertEqual(self.creator.readXml(), 0)
        #self.assertEqual(self.creator.readImageData(), 0)
        self.assertEqual(self.creator.validatePartitionData(partitionFields), rbfdialog.BoardTemplateCreator.NO_IMAGE)
        ...
        self.assertEqual(self.creator.readXml(), 0)
        self.assertEqual(self.creator.readImageData(), 0)
        self.assertEqual(self.creator.validatePartitionData(partitionFields), rbfdialog.BoardTemplateCreator.INVALID_PARTITION_SIZE)
        ...
        self.assertEqual(self.creator.readImageData(), 0)
        self.assertEqual(self.creator.readPartitions(), 0)
        self.assertEqual(self.creator.validatePartitionData(partitionFields), rbfdialog.BoardTemplateCreator.EXTENDED_PARTITION_ERROR)
        ...
        self.assertEqual(self.creator.readImageData(), 0)
        self.assertEqual(self.creator.readPartitions(), 0)
        self.assertEqual(self.creator.validatePartitionData(partitionFields), rbfdialog.BoardTemplateCreator.TOTAL_PARTITIONS_ERROR)
        ...
        self.assertEqual(self.creator.readImageData(), 0)
        self.assertEqual(self.creator.readPartitions(), 0)
        self.assertEqual(self.creator.validatePartitionData(partitionFields), rbfdialog.BoardTemplateCreator.PRIMARY_PARTITION_EXCEEDS)
        ...
        self.assertEqual(self.creator.readImageData(), 0)
        self.assertEqual(self.creator.readPartitions(), 0)
        self.assertEqual(self.creator.validatePartitionData(partitionFields), rbfdialog.BoardTemplateCreator.LOGICAL_BEFORE_EXTENDED)
        ...
        self.assertEqual(self.creator.readImageData(), 0)
        self.assertEqual(self.creator.readPartitions(), 0)
        self.assertEqual(self.creator.validatePartitionData(partitionFields), rbfdialog.BoardTemplateCreator.LOGICAL_PARTITION_EXCEEDS)
    ...
    def test_getTagValue(self):
        ...
        self.creator.setTemplate("test_templates/good.xml")
        self.assertEqual(self.creator.readXml(), 0)
        self.assertEqual(self.creator.getTagValue(self.creator.boardDom,"board"),"cubietruck")
        
    def test_getFilename(self):
        """Teste getFilename function"""
        self.assertEqual(self.creator.getFilename("name"),"name")
        self.assertEqual(self.creator.getFilename("/path/to/some/file/name"),"name")
