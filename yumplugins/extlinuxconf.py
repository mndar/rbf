...
def posttrans_hook(conduit):
    ...
    if rootPath == None:
        conduit.error(2,"Could not find path to / in fstab. Please fix boot configuration manually")
        return
    try:
    ...
    for txmbr in tsInfo:
        ...
        if (packageState == "i" or packageState == "u") and packageName.startswith("kernel-core"):
